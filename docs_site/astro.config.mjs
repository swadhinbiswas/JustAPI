  ...
  integrations: [
    starlight({
      ...
      head: [
        ...
        { tag: 'meta', attrs: { name: 'keywords', content: 'JustAPI, Python, Rust, web framework, API, async, high performance' } },
        ...
        { tag: 'meta', attrs: { property: 'og:description', content: 'Python web framework powered by Rust. Handles 700k+ requests per second without breaking a sweat.' } },
        ...
        { tag: 'meta', attrs: { name: 'twitter:description', content: 'Python web framework powered by Rust. 700k+ requests per second.' } },
